...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $luokkahaku->close();
            echo '<img src="./takakansi.jpg" class="takakansi takakansi" id="takakansi" onload="kasaaVuosikurssi();"></img>';
        ...
        <script type="text/javascript">
            ...
            //tulostaAbi("tuomasalanen");
            //tulostaAbi("roosaaartonen");
            //tulostaAbi("neaaho");
            //kasaaAbi("tuomasalanen");
            //console.log("alanen kasattu");
            //kasaaAbi("roosaaartonen");
            //console.log("aartonen kasattu");
            //kasaaAbi("neaaho");
            //console.log("aho kasattu");
            //haeAbit("16A");
            //haeLuokat(2019); 
        ...
        <!--<script type="text/javascript">
                ...
                lisaaKuvaSivulle("abi","/profiilikuvat/tuomasalanen.jpg",1);
                while(i<150){
